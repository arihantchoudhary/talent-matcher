...
const LINKS = [
  { href: "/rankings", label: "Rankings", icon: "M3 10h18M3 14h18M3 18h18M3 6h18" },
  { href: "/upload", label: "Upload & Score", icon: "M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M17 8l-5-5-5 5M12 3v12" },
