    ...
    <div className="flex-1 overflow-auto">
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="rounded-xl border border-zinc-200 bg-white p-6">
          ...
          <input type="password" placeholder="sk-proj-..." className="w-full border border-zinc-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-300 mb-2" />
